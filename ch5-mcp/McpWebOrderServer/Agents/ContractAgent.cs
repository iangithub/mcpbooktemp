...
namespace McpWebOrderServer.Agents
{
    // 建立一個 ContractAgent 類別
    public static class ContractAgent
    {
        public static async Task<string> Execute(string contract)
        {
