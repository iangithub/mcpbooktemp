...
public static class Lab56
{
    ...
    {
        AssistantClient assistantClient = new AssistantClient(new ApiKeyCredential(Config.OpenAI_ApiKey));
        ...
        // This plugin will be used to handle customer support queries.
